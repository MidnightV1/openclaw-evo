...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.cacheStrategy": "Cache Strategy",
  "agents.defaults.cacheStrategy.systemPromptSegmentation": "System Prompt Segmentation",
  "agents.defaults.cacheStrategy.historyWindowCaching": "History Window Caching",
  "agents.defaults.cacheStrategy.windowSlideInterval": "Window Slide Interval (turns)",
  "agents.defaults.cacheStrategy.subagentWindowSlideInterval": "Subagent Window Slide Interval",
  "agents.defaults.cacheStrategy.minTurnsForCaching": "Min Turns for Caching",
  "agents.defaults.cacheStrategy.subagentMinTurnsForCaching": "Subagent Min Turns for Caching",
  "agents.defaults.adaptivePrompt": "Adaptive Prompt Mode",
